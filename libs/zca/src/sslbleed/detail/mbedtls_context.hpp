...
static inline T* create(const char * location, Args &&... args)
{
...
public:
    ...
    asio::ssl::context_base::options options_;
    boost::asio::const_buffer cert_chain_;
    boost::asio::const_buffer private_key_;
    boost::asio::const_buffer ca_cert_;
};
